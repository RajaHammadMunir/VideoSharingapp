...
class VideoFileView(View):
    ...
    def get(self, request, file_name):
        ...
        print(BASE_DIR)
        print(file_name)
        file = FileWrapper(open(BASE_DIR+'/videosharing/static/videos/'+file_name, 'rb'))
...
class VideoView(View):
    ...
    def get(self, request, id, new):
        ...
        video_by_id = Video.objects.get(id=id)
        BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        video_by_id.path = 'https://videosharingapp.azurewebsites.net/get_video/'+video_by_id.path
        print(video_by_id)
...
class NewVideo(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            filename = fs.save("videosharing/static/videos/"+path, file)
